export class UI {
    constructor(game) {
        ...
        this.livesImage = document.getElementById('lives'); // Corrected the method name here
    }

    draw(context) {
        context.save();
        context.shadowOffsetX = 2; // Fixed typo: shadowOffSetX -> shadowOffsetX
        context.shadowOffsetY = 2; // Fixed typo: shadowOffSetY -> shadowOffsetY
        ...
        context.restore(); // Moved restore to the right place
    }
}
